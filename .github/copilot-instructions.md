# Instrucciones de Copilot — sooft-ai-standards (SOOFT)
...
2. **Después del banner, hacé el init** (estos pasos ya están acá: no hace falta abrir `sooft.prompt.md` en el CLI):
   ...
   - **Detectá integraciones** con evidencia: Git (remote del repositorio), el issue tracker (cualquier prefijo de ticket que use el proyecto, ej. `TICKET-XXXXX`), Jira. No asumas el issue tracker ni su formato sin evidencia.
